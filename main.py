...
@app.post("/api/v1/moderate/text", dependencies=[Depends(RateLimiter(times=100, seconds=60))], tags=["POST"])
...
@app.post("/api/v1/moderate/image", dependencies=[Depends(RateLimiter(times=100, seconds=60))], tags=["POST"])
